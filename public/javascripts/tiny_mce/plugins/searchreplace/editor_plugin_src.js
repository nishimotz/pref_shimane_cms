...
tinyMCE.importPluginLanguagePack('searchreplace', 'en,tr,sv,zh_cn,fa,fr_ca,fr,de,pl,pt_br,cs,nl,da,he,nb,hu,ru,ru_KOI8-R,ru_UTF-8,nn,fi,cy,es,is,zh_tw,zh_tw_utf8,sk,ja');
...
var TinyMCE_SearchReplacePlugin = {
	...
	getControlHTML : function(cn)	{
		switch (cn) {
			...
			case "replace":
				return tinyMCE.getButtonHTML(cn, 'lang_searchreplace_replace_desc', '{$pluginurl}/images/search.gif', 'mceSearchReplace', true);
		}
		return "";
	},
